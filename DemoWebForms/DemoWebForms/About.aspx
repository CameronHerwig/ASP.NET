...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbConnectionString1 %>" SelectCommand="SELECT [Name] FROM [TechItem]"></asp:SqlDataSource>
    </p>
</asp:Content>
